...
echo "定时采集已启动，立即执行首轮..."
cd ~/wechat-collector/collector/app
RSS_AI_ENDPOINT=http://127.0.0.1:3210 MOORE_WECHAT_EXPORTER_SCRIPT=$HOME/wechat-collector/collector/moore/scripts/wechat_exporter.py WECHAT_WIZARD=$HOME/wechat-collector/collector/moore/scripts/wechat_wizard.py WECHAT_DOWNLOADER=$HOME/wechat-collector/collector/moore/scripts/wechat_downloader.py ~/wechat-collector/node/bin/node scripts/wechat-subscription-sync.mjs 2>&1 | tail -15
echo "== 服务器队列状态 =="
